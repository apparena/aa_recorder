...
<head>
    ...
    <meta property="og:title" content="<?=$session->config['fb_share_title']['value']?>" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?=$fb_share_url;?>" />
    <meta property="og:image" content="<?=$session->config['fb_share_img']['value']?>" />
    <meta property="og:site_name" content="<?=$session->config['fb_share_title']['value']?>" />
